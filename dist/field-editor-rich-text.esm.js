...
import { BLOCKS, TOP_LEVEL_BLOCKS, INLINES, CONTAINERS, VOID_BLOCKS, MARKS, EMPTY_DOCUMENT } from '@contentful/rich-text-types';
import { toContentfulDocument, toSlatejsDocument } from '@contentful/contentful-slatejs-adapter';
import { useEntities, MissingEntityCard, WrappedEntryCard, WrappedAssetCard, EntityProvider, ScheduleTooltipContent, ScheduledIconWithTooltip } from '@contentful/field-editor-reference';
import fromPairs from 'lodash-es/fromPairs';
import EditList from '@productboard/slate-edit-list';
import { EditorToolbarButton, EntryCard, AssetCard, Modal, Button, Form, TextField, SelectField, Option, FormLabel, TextLink, Tag, Tooltip, DropdownListItem, Dropdown, DropdownList, Icon, InlineEntryCard, SectionHeading, IconButton, Spinner, SkeletonContainer, SkeletonBodyText, InViewport, EditorToolbar, EditorToolbarDivider } from '@contentful/forma-36-react-components';
...
var ToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(EditorToolbarButton, {
      icon: icon,
      tooltip: title,
      label: title,
      isActive: isActive,
...
var HyperlinkDialog = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(EntityProvider, {
      sdk: this.props.sdk
    }, /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(Modal.Content, null, this.renderFields()), /*#__PURE__*/React__default.createElement(Modal.Controls, null, /*#__PURE__*/React__default.createElement(Button, {
      type: "submit",
      buttonType: "positive",
      onClick: this.handleSubmit,
      disabled: !this.isLinkComplete(),
      testId: "confirm-cta"
    }, labels.confirm), /*#__PURE__*/React__default.createElement(Button, {
      type: "button",
  ...
  _proto.renderFields = function renderFields() {
    ...
    return /*#__PURE__*/React__default.createElement(Form, null, hideText ? null : /*#__PURE__*/React__default.createElement(TextField, {
      required: true,
      labelText: "Link text",
      value: text || '',
    ...
    }), isFeaturingEntitySelector(entitySelectorConfigs) && /*#__PURE__*/React__default.createElement(SelectField, {
      labelText: "Link type",
      value: type,
      onChange: function onChange(e) {
        return _this3.setState({
    ...
    }, allowedHyperlinkTypes.includes(LINK_TYPES.URI) || type === LINK_TYPES.URI ? /*#__PURE__*/React__default.createElement(Option, {
      value: LINK_TYPES.URI
    }, "URL") : null, allowedHyperlinkTypes.includes(LINK_TYPES.ENTRY) || type === LINK_TYPES.ENTRY ? /*#__PURE__*/React__default.createElement(Option, {
      value: LINK_TYPES.ENTRY
    }, "Entry") : null, allowedHyperlinkTypes.includes(LINK_TYPES.ASSET) || type === LINK_TYPES.ASSET ? /*#__PURE__*/React__default.createElement(Option, {
      value: LINK_TYPES.ASSET
    }, "Asset") : null), type === LINK_TYPES.URI ? /*#__PURE__*/React__default.createElement(TextField, {
      required: true,
...
var hyperlinkTooltipStyles = {
  entityContentType: /*#__PURE__*/css({
...
function EntityHyperlinkTooltip(props) {
  ...
  if (requestStatus.type === 'error') {
    ...
    }), /*#__PURE__*/React__default.createElement(ScheduleTooltipContent, {
      job: jobs[0],
...
var Hyperlink = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.renderLink = function renderLink(_ref) {
    ...
    return /*#__PURE__*/React__default.createElement(Tooltip, {
      ...
      place: "bottom",
      maxWidth: "auto"
    }, SUPPORTS_NATIVE_SLATE_HYPERLINKS ? /*#__PURE__*/React__default.createElement(TextLink, {
      ...
      className: cx(styles$2.hyperlink, styles$2.hyperlinkIEFallback)
    }, children));
  };
...
var ToolbarDropdownListItem = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(DropdownListItem, {
      ...
      isActive: isActive,
      "data-test-id": "toolbar-toggle-" + type,
      className: cx(styles$3.root, styles$3[getStyleForType(type)]),
      onClick: this.handleClick
    }, children);
  };
...
var HeadingDropdown = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(Dropdown, {
      toggleElement: /*#__PURE__*/React__default.createElement(Button, {
        onClick: onToggle,
...
var EntryLinkToolbarIcon = /*#__PURE__*/function (_Component) {
  ...
  _proto.render = function render() {
    ...
    }, "Embed inline entry") : /*#__PURE__*/React__default.createElement(DropdownListItem, {
...
var FetchingWrappedInlineEntryCard = function FetchingWrappedInlineEntryCard(props) {
  ...
  return /*#__PURE__*/React__default.createElement(InlineEntryCard, {
    ...
    status: status,
    dropdownListElements: !props.isReadOnly ? /*#__PURE__*/React__default.createElement(DropdownList, null, /*#__PURE__*/React__default.createElement(DropdownListItem, {
      onClick: props.onEdit
    }, "Edit"), /*#__PURE__*/React__default.createElement(DropdownListItem, {
...
var styles$8 = {
  hr: /*#__PURE__*/css( /*#__PURE__*/_templateObject(), tokens.spacingM, tokens.spacingL, tokens.colorElementMid),
  hrSelected: /*#__PURE__*/css( /*#__PURE__*/_templateObject2(), tokens.colorPrimary, tokens.colorPrimary, tokens.colorPrimary)
};
    ...
    renderNode: function renderNode(props, _editor, next) {
      if (props.node.type === BLOCKS.HR) {
        return /*#__PURE__*/React__default.createElement("hr", _extends({
          className: cx(styles$8.hr, props.isSelected && styles$8.hrSelected)
        }, props.attributes));
      }
...
var CommandPanel = /*#__PURE__*/function (_React$Component2) {
  ...
  function CommandPanel() {
    ...
    _this3.renderNavigationBar = function () {
      ...
      }, /*#__PURE__*/React__default.createElement(SectionHeading, null, _this3.props.breadcrumb ? "Embed " + _this3.props.breadcrumb : 'Richtext Commands'), /*#__PURE__*/React__default.createElement(IconButton, {
        label: "Close",
...
var Toolbar = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/React__default.createElement(EditorToolbar, {
      ...
      disabled: props.disabled
    }, /*#__PURE__*/React__default.createElement(Paragraph$1, props), isNodeTypeEnabled(field, BLOCKS.HEADING_1) && /*#__PURE__*/React__default.createElement(Heading1, props), isNodeTypeEnabled(field, BLOCKS.HEADING_2) && /*#__PURE__*/React__default.createElement(Heading2, props), isNodeTypeEnabled(field, BLOCKS.HEADING_3) && /*#__PURE__*/React__default.createElement(Heading3, props), isNodeTypeEnabled(field, BLOCKS.HEADING_4) && /*#__PURE__*/React__default.createElement(Heading4, props), isNodeTypeEnabled(field, BLOCKS.HEADING_5) && /*#__PURE__*/React__default.createElement(Heading5, props), isNodeTypeEnabled(field, BLOCKS.HEADING_6) && /*#__PURE__*/React__default.createElement(Heading6, props)), isAnyMarkEnabled && /*#__PURE__*/React__default.createElement(EditorToolbarDivider, {
      testId: "mark-divider"
    }), isMarkEnabled(field, MARKS.BOLD) && /*#__PURE__*/React__default.createElement(Bold$1, props), isMarkEnabled(field, MARKS.ITALIC) && /*#__PURE__*/React__default.createElement(Italic$1, props), isMarkEnabled(field, MARKS.UNDERLINE) && /*#__PURE__*/React__default.createElement(Underlined$1, props), isMarkEnabled(field, MARKS.CODE) && /*#__PURE__*/React__default.createElement(Code$1, props), isMarkEnabled(field, MARKS.SUPERSCRIPT) && /*#__PURE__*/React__default.createElement(Superscript$1, props), isMarkEnabled(field, MARKS.SUBSCRIPT) && /*#__PURE__*/React__default.createElement(Subscript$1, props), isAnyHyperlinkEnabled && /*#__PURE__*/React__default.createElement(React__default.Fragment, null, /*#__PURE__*/React__default.createElement(EditorToolbarDivider, {
      testId: "hyperlink-divider"
    }), /*#__PURE__*/React__default.createElement(HyperlinkToolbarIcon, props)), isAnyListEnabled && /*#__PURE__*/React__default.createElement(EditorToolbarDivider, {
      testId: "list-divider"
...
function getValidationInfo(field) {
  var isAnyMarkEnabled = isMarkEnabled(field, MARKS.BOLD) || isMarkEnabled(field, MARKS.ITALIC) || isMarkEnabled(field, MARKS.UNDERLINE) || isMarkEnabled(field, MARKS.CODE) || isMarkEnabled(field, MARKS.SUPERSCRIPT) || isMarkEnabled(field, MARKS.SUBSCRIPT);
...
var styles$b = {
  nativeSticky: /*#__PURE__*/css( /*#__PURE__*/_templateObject$1())
};
